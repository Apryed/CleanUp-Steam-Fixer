@echo off
title Steam Cleaner, Checker and Fixer By Apryed
Color A
:LANGUAGE
cls
echo ============================
...
SET LANG=%ERRORLEVEL%
IF %LANG% EQU 2 title Limpiador, Comprobador y reparador de Steam por Apryed
cls
...
IF %LANG% EQU 1 echo Open Steam, let it open completly. Then press any button to continue...
IF %LANG% EQU 2 echo Paso 2/3
IF %LANG% EQU 2 echo Reparando Servicio de Steam
IF %LANG% EQU 2 echo Abre Steam, deja que inicie completamente. Luego apreta cualquier tecla para continuar...
pause >nul
taskkill /F /IM Steam.exe /T
timeout /T 15 /NOBREAK
