...
ECHO.
ECHO.
IF %UILanguage% EQU 0c0a ( ECHO Paso 2/3 && ECHO Reparando Servicio de Steam && ECHO Abre Steam, deja que inicie completamente. Luego apreta cualquier tecla para continuar... ) ELSE ( ECHO Step 2/3 && ECHO Repairing Steam Service && ECHO Open Steam, let it open completly. Then press any button to continue... )
PAUSE >nul
taskkill /F /IM Steam.exe /T
